...
function urlSafeBase64Encode(value) {
  return encode$1(value).replaceAll('+', '-').replaceAll('/', '_').replaceAll('=', '.');
}
...
export { urlGetSearchParam, urlGetSearchParams, urlGetSearchString, urlSafeBase64Decode, urlSafeBase64Encode };
